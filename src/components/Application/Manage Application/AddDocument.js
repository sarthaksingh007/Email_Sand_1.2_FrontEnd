...
import { createDocumentAction } from "../../../Redux/actions/Manage Application/documentsActions";
...
const AddDocument = () => {
  ...
  const documentsCreate = useSelector((state) => state.documentCreate);
  const { loading, error, documents } = documentsCreate;
      ...
      <form onSubmit={submitHandler}>
        ...
        <div class="magazin-container">
          ...
          <form class="row g-3 d-flex justify-content-between">
            ...
            <iframe src={uploadDocument} height="100%" width="50%"></iframe>
